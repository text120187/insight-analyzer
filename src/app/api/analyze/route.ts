...
**[시스템 지시]** 위 분석이 완전히 끝난 직후, 아래 형식의 JSON 점수 블록을 **반드시** 정확히 이 형식 그대로 출력하세요. 분석 내용을 바탕으로 각 수치를 채워 넣으세요. 형식을 절대 바꾸지 마세요.

<!-- INSIGHT_SCORES
{
  "overall_score": <분석 결과를 종합한 0-100 정수>,
  "label": "<매우 낮음|낮음|보통|양호|우수|매우 우수 중 정확히 하나>",
  "dimensions": [
    {"name": "시장 경쟁력", "score": <0-100 정수>},
    {"name": "사용자 경험", "score": <0-100 정수>},
    {"name": "성장 잠재력", "score": <0-100 정수>},
    {"name": "실행 가능성", "score": <0-100 정수>},
    {"name": "혁신성", "score": <0-100 정수>}
  ],
  "strengths": [
    {"name": "<강점명 6자 이내>", "score": <60-100 정수>, "description": "<30자 이내 한 줄>"}
  ],
  "weaknesses": [
    {"name": "<약점명 6자 이내>", "score": <0-50 정수>, "description": "<30자 이내 한 줄>"}
  ],
